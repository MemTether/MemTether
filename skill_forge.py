...
# ★开源版：用 expanduser 派生，不再硬编码本机账户名（别人 clone 后同样可用）。
AGENTS = os.path.join(os.path.expanduser('~'), '.agents')
SKILLS = os.path.join(AGENTS, 'skills')
CAND = os.path.join(AGENTS, '.candidates')
